...
pkglibexecdir = $(libexecdir)/iftop
...
target_triplet = i386-apple-darwin17.7.0
...
am__depfiles_remade = ./$(DEPDIR)/addr_hash.Po \
	./$(DEPDIR)/addrs_dlpi.Po ./$(DEPDIR)/addrs_ioctl.Po \
	./$(DEPDIR)/cfgfile.Po ./$(DEPDIR)/dlcommon.Po \
	./$(DEPDIR)/edline.Po ./$(DEPDIR)/hash.Po ./$(DEPDIR)/iftop.Po \
	...
	./$(DEPDIR)/ui.Po ./$(DEPDIR)/util.Po ./$(DEPDIR)/vector.Po
am__mv = mv -f
...
STRIP = 
VERSION = 1.0pre2
abs_builddir = /Users/wizard/forkedRepos/iftopcolor
abs_srcdir = /Users/wizard/forkedRepos/iftopcolor
abs_top_builddir = /Users/wizard/forkedRepos/iftopcolor
abs_top_srcdir = /Users/wizard/forkedRepos/iftopcolor
ac_aux_dir = config
ac_ct_CC = gcc
am__include = include
am__leading_dot = .
...
install_sh = ${SHELL} /Users/wizard/forkedRepos/iftopcolor/config/install-sh
...
target = i386-apple-darwin17.7.0
target_alias = 
target_cpu = i386
...
iftop$(EXEEXT): $(iftop_OBJECTS) $(iftop_DEPENDENCIES) $(EXTRA_iftop_DEPENDENCIES) 
	@rm -f iftop$(EXEEXT)
	$(AM_V_CCLD)$(LINK) $(iftop_OBJECTS) $(iftop_LDADD) $(LIBS)
...
include ./$(DEPDIR)/addr_hash.Po # am--include-marker
include ./$(DEPDIR)/addrs_dlpi.Po # am--include-marker
include ./$(DEPDIR)/addrs_ioctl.Po # am--include-marker
include ./$(DEPDIR)/cfgfile.Po # am--include-marker
include ./$(DEPDIR)/dlcommon.Po # am--include-marker
include ./$(DEPDIR)/edline.Po # am--include-marker
include ./$(DEPDIR)/hash.Po # am--include-marker
include ./$(DEPDIR)/iftop.Po # am--include-marker
include ./$(DEPDIR)/ns_hash.Po # am--include-marker
include ./$(DEPDIR)/options.Po # am--include-marker
include ./$(DEPDIR)/resolver.Po # am--include-marker
include ./$(DEPDIR)/screenfilter.Po # am--include-marker
include ./$(DEPDIR)/serv_hash.Po # am--include-marker
include ./$(DEPDIR)/sorted_list.Po # am--include-marker
include ./$(DEPDIR)/stringmap.Po # am--include-marker
include ./$(DEPDIR)/threadprof.Po # am--include-marker
...
distclean: distclean-recursive
	-rm -f $(am__CONFIG_DISTCLEAN_FILES)
		-rm -f ./$(DEPDIR)/addr_hash.Po
	-rm -f ./$(DEPDIR)/addrs_dlpi.Po
	-rm -f ./$(DEPDIR)/addrs_ioctl.Po
	-rm -f ./$(DEPDIR)/cfgfile.Po
	-rm -f ./$(DEPDIR)/dlcommon.Po
	-rm -f ./$(DEPDIR)/edline.Po
	-rm -f ./$(DEPDIR)/hash.Po
	-rm -f ./$(DEPDIR)/iftop.Po
	-rm -f ./$(DEPDIR)/ns_hash.Po
	-rm -f ./$(DEPDIR)/options.Po
	-rm -f ./$(DEPDIR)/resolver.Po
	-rm -f ./$(DEPDIR)/screenfilter.Po
	-rm -f ./$(DEPDIR)/serv_hash.Po
	-rm -f ./$(DEPDIR)/sorted_list.Po
	-rm -f ./$(DEPDIR)/stringmap.Po
	-rm -f ./$(DEPDIR)/threadprof.Po
	-rm -f ./$(DEPDIR)/ui.Po
	-rm -f ./$(DEPDIR)/util.Po
